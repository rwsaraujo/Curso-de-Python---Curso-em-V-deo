...
[EN]
> Make a program that has a function called larger (), that takes several parameters with integer values. Your program
has to analyze all the values and say which one is the largest.
"""
#Gustavo Guanabara
